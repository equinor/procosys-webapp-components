...
* Run "npm start"
* Run "npm link @equinor/procosys-webapp-components" in the app you want to test the code in.

To unlink
* Run "npm unlink @equinor/procosys-webapp-components" in the app you tested the code in.
